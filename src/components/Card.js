...
const Card = () => {
  return (
    <>
      {/* Outer Desktop */}
      <div className="columns has-background-light is-centered is-marginless is-gapless">
        {/* Absolute Trick */}
        ...
        {/* Inner */}
        <div className="column my-6 has-background-white is-6-desktop is-9-tablet px-0 py-0">
          {/* Inner */}
